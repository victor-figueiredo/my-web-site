...
const Footer = () => {
  return (
    <div className="pt-[8rem] pb-[4rem] bg-[#02050a] w-[100vw]">
      <div className="w-[100%] border-b-[1px] border-gray-400 ">
        <div className="grid pb-[6rem] grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[80%] mx-auto gap-[3rem]">
          ...
          <div className="flex items-center xl:justify-center space-x-6">
            <div className="md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#152D53]">
          ...
          <div className="flex items-center space-x-6 xl:justify-end">
            <div className="md:min-w-[6.5rem] md:min-h-[6.5rem] min-w-[5rem] min-h-[5rem] flex items-center justify-center rounded-full bg-[#152D53]">
